...
return byoubu.color.mix((function (){var iter__5480__auto__ = (function byoubu$facts$declared_content_color_$_iter__22550(s__22551){
return (new cljs.core.LazySeq(null,(function (){
var s__22551__$1 = s__22551;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22551__$1);
if(temp__5825__auto__){
var s__22551__$2 = temp__5825__auto__;
...
var vec__22555 = cljs.core._nth(c__5478__auto__,i__22552);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22555,(1),null);
cljs.core.chunk_append(b__22553,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null));

var G__22604 = (i__22552 + (1));
i__22552 = G__22604;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22553),byoubu$facts$declared_content_color_$_iter__22550(cljs.core.chunk_rest(s__22551__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22553),null);
}
} else {
var vec__22562 = cljs.core.first(s__22551__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(0),null);
var w = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22562,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(backdrop,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("byoubu","palette","byoubu/palette",851879321),k], null)),w], null),byoubu$facts$declared_content_color_$_iter__22550(cljs.core.rest(s__22551__$2)));
}
} else {
return null;
}
...
var G__22567 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"declared","declared",92336021),byoubu.facts.declared_content_color(backdrop)], null);
var G__22567__$1 = (cljs.core.truth_(cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22567,new cljs.core.Keyword(null,"plate","plate",-1920178141),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"plate","plate",-1920178141),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null))):G__22567);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22567__$1,new cljs.core.Keyword(null,"poster","poster",-1616913550),cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(m,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"poster","poster",-1616913550),new cljs.core.Keyword(null,"content-color","content-color",1294205929)], null)));
} else {
return G__22567__$1;
}
});
...
return cljs.core.first(cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2((function (p__22573){
var vec__22574 = p__22573;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22574,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22574,(1),null);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22574,(2),null);
return (- r);
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__22577){
var vec__22578 = p__22577;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22578,(0),null);
var hex = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22578,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,hex,cljs.core.reduce.cljs$core$IFn$_invoke$arity$2(cljs.core.min,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22570_SHARP_){
var or__5002__auto__ = byoubu.color.contrast_ratio(hex,p1__22570_SHARP_);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return 0.0;
...
var vec__22584 = byoubu.facts.best_ink(cljs.core.vals(tiers));
var ink_key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22584,(0),null);
var ink = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22584,(1),null);
var ratio = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22584,(2),null);
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22592),byoubu$facts$derive_facts_$_iter__22589(cljs.core.chunk_rest(s__22590__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22592),null);
}
} else {
var vec__22599 = cljs.core.first(s__22590__$2);
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22599,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22599,(1),null);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [t,byoubu.color.contrast_ratio(ink,c)], null),byoubu$facts$derive_facts_$_iter__22589(cljs.core.rest(s__22590__$2)));
}
} else {
return null;
}
