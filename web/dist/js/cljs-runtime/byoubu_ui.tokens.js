...
return [":root { ",clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",(function (){var iter__5480__auto__ = (function byoubu_ui$tokens$iter__22743(s__22744){
return (new cljs.core.LazySeq(null,(function (){
var s__22744__$1 = s__22744;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22744__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__22751 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22751,(0),null);
var ks = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22751,(1),null);
var iterys__5476__auto__ = ((function (s__22744__$1,vec__22751,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function byoubu_ui$tokens$iter__22743_$_iter__22745(s__22746){
return (new cljs.core.LazySeq(null,((function (s__22744__$1,vec__22751,group,ks,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__22746__$1 = s__22746;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22746__$1);
if(temp__5825__auto____$1){
var s__22746__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22746__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22746__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22748 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22747 = (0);
while(true){
if((i__22747 < size__5479__auto__)){
var vec__22755 = cljs.core._nth(c__5478__auto__,i__22747);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22755,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22755,(1),null);
cljs.core.chunk_append(b__22748,[byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''));

var G__22826 = (i__22747 + (1));
i__22747 = G__22826;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22748),byoubu_ui$tokens$iter__22743_$_iter__22745(cljs.core.chunk_rest(s__22746__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22748),null);
}
} else {
var vec__22758 = cljs.core.first(s__22746__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22758,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22758,(1),null);
return cljs.core.cons([byoubu_ui.tokens.var_name(cljs.core.name(group),k),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(v),";"].join(''),byoubu_ui$tokens$iter__22743_$_iter__22745(cljs.core.rest(s__22746__$2)));
}
} else {
return null;
}
...
});})(s__22744__$1,vec__22751,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__22744__$1,vec__22751,group,ks,xs__6385__auto__,temp__5825__auto__,tokens))
;
...
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,byoubu_ui$tokens$iter__22743(cljs.core.rest(s__22744__$1)));
} else {
var G__22835 = cljs.core.rest(s__22744__$1);
s__22744__$1 = G__22835;
continue;
}
} else {
return null;
