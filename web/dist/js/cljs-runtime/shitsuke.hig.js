...
return cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22784){
 ...
 */
shitsuke.hig.default_hig_tokens = new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword("hig","font","hig/font",-1506004751),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"text","text",-1790561697),shitsuke.hig.font_family_text,new cljs.core.Keyword(null,"display","display",242065432),shitsuke.hig.font_family_display,new cljs.core.Keyword(null,"mono","mono",-1777958350),shitsuke.hig.font_family_mono], null),new cljs.core.Keyword("hig","text","hig/text",-1790736923),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22798){
var vec__22799 = p__22798;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22799,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22799,(1),null);
...
})),shitsuke.hig.text_styles),cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__22802){
var vec__22803 = p__22802;
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22803,(0),null);
var props = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22803,(1),null);
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$pair__GT_css_$_iter__22815(s__22816){
return (new cljs.core.LazySeq(null,(function (){
var s__22816__$1 = s__22816;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22816__$1);
if(temp__5825__auto__){
var s__22816__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22816__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22816__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22818 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22817 = (0);
while(true){
if((i__22817 < size__5479__auto__)){
var vec__22823 = cljs.core._nth(c__5478__auto__,i__22817);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22823,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22823,(1),null);
cljs.core.chunk_append(b__22818,["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__23070 = (i__22817 + (1));
i__22817 = G__23070;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22818),shitsuke$hig$pair__GT_css_$_iter__22815(cljs.core.chunk_rest(s__22816__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22818),null);
}
} else {
var vec__22829 = cljs.core.first(s__22816__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22829,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22829,(1),null);
return cljs.core.cons(["  ",shitsuke.hig.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$hig$pair__GT_css_$_iter__22815(cljs.core.rest(s__22816__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$tokens__GT_css_lines_$_iter__22838(s__22839){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__22842 = cljs.core._nth(c__5478__auto__,i__22840);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22842,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22842,(1),null);
if((!((m == null)))){
cljs.core.chunk_append(b__22841,((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (i__22840,s__22839__$1,vec__22842,group,m,c__5478__auto__,size__5479__auto__,b__22841,s__22839__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__22838_$_iter__22901(s__22902){
return (new cljs.core.LazySeq(null,((function (i__22840,s__22839__$1,vec__22842,group,m,c__5478__auto__,size__5479__auto__,b__22841,s__22839__$2,temp__5825__auto__){
return (function (){
var s__22902__$1 = s__22902;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22902__$1);
if(temp__5825__auto____$1){
var s__22902__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22902__$2)){
var c__5478__auto____$1 = cljs.core.chunk_first(s__22902__$2);
var size__5479__auto____$1 = cljs.core.count(c__5478__auto____$1);
var b__22904 = cljs.core.chunk_buffer(size__5479__auto____$1);
if((function (){var i__22903 = (0);
while(true){
if((i__22903 < size__5479__auto____$1)){
var vec__22917 = cljs.core._nth(c__5478__auto____$1,i__22903);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22917,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22917,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__22904,shitsuke.hig.pair__GT_css(group,k,v));

var G__23090 = (i__22903 + (1));
i__22903 = G__23090;
continue;
} else {
var G__23091 = (i__22903 + (1));
i__22903 = G__23091;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22904),shitsuke$hig$tokens__GT_css_lines_$_iter__22838_$_iter__22901(cljs.core.chunk_rest(s__22902__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22904),null);
}
} else {
var vec__22924 = cljs.core.first(s__22902__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__22838_$_iter__22901(cljs.core.rest(s__22902__$2)));
} else {
var G__23095 = cljs.core.rest(s__22902__$2);
s__22902__$1 = G__23095;
continue;
}
}
} else {
...
});})(i__22840,s__22839__$1,vec__22842,group,m,c__5478__auto__,size__5479__auto__,b__22841,s__22839__$2,temp__5825__auto__))
,null,null));
});})(i__22840,s__22839__$1,vec__22842,group,m,c__5478__auto__,size__5479__auto__,b__22841,s__22839__$2,temp__5825__auto__))
;
...
var G__23096 = (i__22840 + (1));
i__22840 = G__23096;
continue;
} else {
var G__23097 = (i__22840 + (1));
i__22840 = G__23097;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22841),shitsuke$hig$tokens__GT_css_lines_$_iter__22838(cljs.core.chunk_rest(s__22839__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22841),null);
}
} else {
var vec__22937 = cljs.core.first(s__22839__$2);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22937,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22937,(1),null);
if((!((m == null)))){
return cljs.core.cons(((cljs.core.map_QMARK_(m))?clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = ((function (s__22839__$1,vec__22937,group,m,s__22839__$2,temp__5825__auto__){
return (function shitsuke$hig$tokens__GT_css_lines_$_iter__22838_$_iter__22941(s__22942){
return (new cljs.core.LazySeq(null,((function (s__22839__$1,vec__22937,group,m,s__22839__$2,temp__5825__auto__){
return (function (){
...
var vec__22953 = cljs.core._nth(c__5478__auto__,i__22943);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22944,shitsuke.hig.pair__GT_css(group,k,v));

var G__23100 = (i__22943 + (1));
i__22943 = G__23100;
continue;
} else {
var G__23101 = (i__22943 + (1));
i__22943 = G__23101;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22944),shitsuke$hig$tokens__GT_css_lines_$_iter__22838_$_iter__22941(cljs.core.chunk_rest(s__22942__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22944),null);
}
} else {
var vec__22956 = cljs.core.first(s__22942__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22956,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22956,(1),null);
if((!((v == null)))){
return cljs.core.cons(shitsuke.hig.pair__GT_css(group,k,v),shitsuke$hig$tokens__GT_css_lines_$_iter__22838_$_iter__22941(cljs.core.rest(s__22942__$2)));
} else {
var G__23102 = cljs.core.rest(s__22942__$2);
s__22942__$1 = G__23102;
continue;
}
}
} else {
...
});})(s__22839__$1,vec__22937,group,m,s__22839__$2,temp__5825__auto__))
,null,null));
});})(s__22839__$1,vec__22937,group,m,s__22839__$2,temp__5825__auto__))
;
return iter__5480__auto__(m);
})()):["  --hig-",cljs.core.name(group),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(m),";"].join('')),shitsuke$hig$tokens__GT_css_lines_$_iter__22838(cljs.core.rest(s__22839__$2)));
} else {
var G__23103 = cljs.core.rest(s__22839__$2);
s__22839__$1 = G__23103;
continue;
}
}
} else {
 ...
 *   `@layer kotoba.hig`.
 */
shitsuke.hig.text_style_classes = ["@layer kotoba.hig {\n",clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$hig$iter__22993(s__22994){
return (new cljs.core.LazySeq(null,(function (){
var s__22994__$1 = s__22994;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22994__$1);
if(temp__5825__auto__){
var s__22994__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22994__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22994__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22996 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22995 = (0);
while(true){
if((i__22995 < size__5479__auto__)){
var style = cljs.core._nth(c__5478__auto__,i__22995);
cljs.core.chunk_append(b__22996,[".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''));

var G__23139 = (i__22995 + (1));
i__22995 = G__23139;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22996),shitsuke$hig$iter__22993(cljs.core.chunk_rest(s__22994__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22996),null);
}
} else {
var style = cljs.core.first(s__22994__$2);
return cljs.core.cons([".hig-",cljs.core.name(style)," {\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(shitsuke.hig.text_style_props.cljs$core$IFn$_invoke$arity$1(style)),"\n}"].join(''),shitsuke$hig$iter__22993(cljs.core.rest(s__22994__$2)));
}
} else {
return null;
}
