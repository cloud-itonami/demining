 ...
 */
kotoba_ui.shell.with_root_attrs = (function kotoba_ui$shell$with_root_attrs(base,p__23047){
var map__23048 = p__23047;
var map__23048__$1 = cljs.core.__destructure_map(map__23048);
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23048__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23048__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var attrs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23048__$1,new cljs.core.Keyword(null,"attrs","attrs",-2090668713));
var G__23049 = ((cljs.core.seq(attrs))?cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([attrs,base], 0)):base);
var G__23049__$1 = (((!((class$ == null))))?cljs.core.update.cljs$core$IFn$_invoke$arity$4(G__23049,new cljs.core.Keyword(null,"class","class",-2030961996),kotoba_ui.shell.cls,kotoba_ui.shell.class_opt__GT_str(class$)):G__23049);
if((!((id == null)))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23049__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__23049__$1;
}
});
...
var len__5726__auto___23114 = arguments.length;
var i__5727__auto___23115 = (0);
while(true){
if((i__5727__auto___23115 < len__5726__auto___23114)){
args__5732__auto__.push((arguments[i__5727__auto___23115]));

var G__23119 = (i__5727__auto___23115 + (1));
i__5727__auto___23115 = G__23119;
continue;
} else {
}
break;
...
var vec__23053 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23053,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23053,(1),null);
var map__23056 = opts;
var map__23056__$1 = cljs.core.__destructure_map(map__23056);
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
var align = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"align","align",1964212802));
var justify = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23056__$1,new cljs.core.Keyword(null,"justify","justify",-722524056));
...
/** @this {Function} */
(kotoba_ui.shell.stack.cljs$lang$applyTo = (function (seq23052){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23052));
}));
...
while(true){
if((i__5727__auto___23134 < len__5726__auto___23132)){
...
var vec__23071 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23071,(0),null);
var children = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23071,(1),null);
var map__23074 = opts;
var map__23074__$1 = cljs.core.__destructure_map(map__23074);
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23074__$1,new cljs.core.Keyword(null,"title","title",636505583));
var wide = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23074__$1,new cljs.core.Keyword(null,"wide","wide",-151772487));
...
/** @this {Function} */
(kotoba_ui.shell.section.cljs$lang$applyTo = (function (seq23069){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23069));
}));
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23075__$1,new cljs.core.Keyword(null,"title","title",636505583));
var tagline = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23075__$1,new cljs.core.Keyword(null,"tagline","tagline",281987682));
var actions = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23075__$1,new cljs.core.Keyword(null,"actions","actions",-812656882));
...
var vec__23077 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23077,(0),null);
var cards = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23077,(1),null);
var map__23080 = opts;
var map__23080__$1 = cljs.core.__destructure_map(map__23080);
var min_w = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23080__$1,new cljs.core.Keyword(null,"min","min",444991522));
var gap = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23080__$1,new cljs.core.Keyword(null,"gap","gap",80255254));
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),kotoba_ui.shell.with_root_attrs((function (){var G__23081 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),(kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1 ? kotoba_ui.shell.class_name.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"grid","grid",402978600)) : kotoba_ui.shell.class_name.call(null, new cljs.core.Keyword(null,"grid","grid",402978600)))], null);
if(cljs.core.seq(style)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23081,new cljs.core.Keyword(null,"style","style",-496642736),style);
} else {
return G__23081;
}
})(),opts)], null),cards);
...
/** @this {Function} */
(kotoba_ui.shell.grid.cljs$lang$applyTo = (function (seq23076){
var self__5712__auto__ = this;
...
var i__5727__auto___23187 = (0);
while(true){
if((i__5727__auto___23187 < len__5726__auto___23186)){
args__5732__auto__.push((arguments[i__5727__auto___23187]));

var G__23188 = (i__5727__auto___23187 + (1));
i__5727__auto___23187 = G__23188;
continue;
} else {
}
break;
...
var vec__23083 = kotoba_ui.shell.split_opts(args);
var opts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23083,(0),null);
var content = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23083,(1),null);
var map__23086 = opts;
var map__23086__$1 = cljs.core.__destructure_map(map__23086);
var nav = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23086__$1,new cljs.core.Keyword(null,"nav","nav",719540477));
var sidebar = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23086__$1,new cljs.core.Keyword(null,"sidebar","sidebar",35784458));
...
/** @this {Function} */
(kotoba_ui.shell.app_shell.cljs$lang$applyTo = (function (seq23082){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq23082));
}));
...
var G__23196 = (i__5727__auto___23195 + (1));
i__5727__auto___23195 = G__23196;
continue;
} else {
}
break;
...
var title = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23098__$1,new cljs.core.Keyword(null,"title","title",636505583));
var description = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23098__$1,new cljs.core.Keyword(null,"description","description",-1428560544));
var lang = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23098__$1,new cljs.core.Keyword(null,"lang","lang",-1819677104));
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23098__$1,new cljs.core.Keyword(null,"theme","theme",-1247880880));
var head = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23098__$1,new cljs.core.Keyword(null,"head","head",-771383919));
...
var map__23099 = kotoba_ui.theme.theme_colors(theme);
var map__23099__$1 = cljs.core.__destructure_map(map__23099);
var light = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23099__$1,new cljs.core.Keyword(null,"light","light",1918998747));
var dark = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__23099__$1,new cljs.core.Keyword(null,"dark","dark",1818973999));
...
})()], null),(cljs.core.truth_(description)?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"description",new cljs.core.Keyword(null,"content","content",15833224),description], null)], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"dark"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23104 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),light], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23104,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: light)");
} else {
return G__23104;
}
})()], null):null),((cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(appearance,"light"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"meta","meta",1499536964),(function (){var G__23106 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"name","name",1843675177),"theme-color",new cljs.core.Keyword(null,"content","content",15833224),dark], null);
if((appearance == null)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__23106,new cljs.core.Keyword(null,"media","media",-1066138403),"(prefers-color-scheme: dark)");
} else {
return G__23106;
}
...
/** @this {Function} */
(kotoba_ui.shell.page.cljs$lang$applyTo = (function (seq23092){
var G__23093 = cljs.core.first(seq23092);
var seq23092__$1 = cljs.core.next(seq23092);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23093,seq23092__$1);
}));
