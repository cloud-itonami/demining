...
/** @this {Function} */
(shitsuke.tokens.deep_merge.cljs$lang$applyTo = (function (seq21866){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21866));
}));
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$pair__GT_css_$_iter__21880(s__21881){
return (new cljs.core.LazySeq(null,(function (){
var s__21881__$1 = s__21881;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__21881__$1);
if(temp__5825__auto__){
var s__21881__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__21881__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21881__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21883 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21882 = (0);
while(true){
if((i__21882 < size__5479__auto__)){
var vec__21886 = cljs.core._nth(c__5478__auto__,i__21882);
...
cljs.core.chunk_append(b__21883,["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__21969 = (i__21882 + (1));
i__21882 = G__21969;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21883),shitsuke$tokens$pair__GT_css_$_iter__21880(cljs.core.chunk_rest(s__21881__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21883),null);
}
} else {
var vec__21895 = cljs.core.first(s__21881__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21895,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21895,(1),null);
return cljs.core.cons(["  ",shitsuke.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),shitsuke$tokens$pair__GT_css_$_iter__21880(cljs.core.rest(s__21881__$2)));
}
} else {
return null;
}
...
var body = clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function shitsuke$tokens$iter__21905(s__21906){
return (new cljs.core.LazySeq(null,(function (){
...
var vec__21911 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21911,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21911,(1),null);
var iterys__5476__auto__ = ((function (s__21906__$1,vec__21911,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function shitsuke$tokens$iter__21905_$_iter__21907(s__21908){
return (new cljs.core.LazySeq(null,((function (s__21906__$1,vec__21911,group,m,xs__6385__auto__,temp__5825__auto__,tokens){
return (function (){
var s__21908__$1 = s__21908;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__21908__$1);
if(temp__5825__auto____$1){
var s__21908__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__21908__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__21908__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__21910 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__21909 = (0);
while(true){
if((i__21909 < size__5479__auto__)){
var vec__21914 = cljs.core._nth(c__5478__auto__,i__21909);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21914,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21914,(1),null);
if((!((v == null)))){
cljs.core.chunk_append(b__21910,shitsuke.tokens.pair__GT_css(group,k,v));

var G__21985 = (i__21909 + (1));
i__21909 = G__21985;
continue;
} else {
var G__21986 = (i__21909 + (1));
i__21909 = G__21986;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__21910),shitsuke$tokens$iter__21905_$_iter__21907(cljs.core.chunk_rest(s__21908__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__21910),null);
}
} else {
var vec__21917 = cljs.core.first(s__21908__$2);
...
if((!((v == null)))){
return cljs.core.cons(shitsuke.tokens.pair__GT_css(group,k,v),shitsuke$tokens$iter__21905_$_iter__21907(cljs.core.rest(s__21908__$2)));
} else {
var G__21987 = cljs.core.rest(s__21908__$2);
s__21908__$1 = G__21987;
continue;
}
}
} else {
...
});})(s__21906__$1,vec__21911,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
,null,null));
});})(s__21906__$1,vec__21911,group,m,xs__6385__auto__,temp__5825__auto__,tokens))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,shitsuke$tokens$iter__21905(cljs.core.rest(s__21906__$1)));
} else {
var G__21989 = cljs.core.rest(s__21906__$1);
s__21906__$1 = G__21989;
continue;
}
} else {
return null;
...
var map__21924 = deck_design;
var map__21924__$1 = cljs.core.__destructure_map(map__21924);
var theme = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21924__$1,new cljs.core.Keyword("slides","theme","slides/theme",-79736158));
var text_styles = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21924__$1,new cljs.core.Keyword("slides","text-styles","slides/text-styles",-2082623934));
...
var color_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21925){
...
var type_tokens = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21933){
var vec__21934 = p__21933;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21934,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21934,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [id,(function (){var G__21937 = cljs.core.PersistentArrayMap.EMPTY;
var G__21937__$1 = (cljs.core.truth_(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21937,new cljs.core.Keyword(null,"font-size","font-size",-1847940346),[cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword("slides","font-size","slides/font-size",1476068328).cljs$core$IFn$_invoke$arity$1(ts)),"px"].join('')):G__21937);
var G__21937__$2 = (cljs.core.truth_(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21937__$1,new cljs.core.Keyword(null,"color","color",1011675173),shitsuke.tokens.normalize_hex(new cljs.core.Keyword("slides","color","slides/color",1659726595).cljs$core$IFn$_invoke$arity$1(ts))):G__21937__$1);
if(cljs.core.truth_(new cljs.core.Keyword("slides","bold","slides/bold",-1297473049).cljs$core$IFn$_invoke$arity$1(ts))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21937__$2,new cljs.core.Keyword(null,"font-weight","font-weight",2085804583),(700));
} else {
return G__21937__$2;
}
})()], null);
})),text_styles);
var font_family = (function (){var or__5002__auto__ = (function (){var G__21938 = new cljs.core.Keyword("office-style.font","majorFont","office-style.font/majorFont",1886256746).cljs$core$IFn$_invoke$arity$1(fonts);
if((G__21938 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__21938),", system-ui, sans-serif"].join('');
}
})();
...
var G__21939 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("shitsuke","colors","shitsuke/colors",-494612392),color_tokens], null);
if(cljs.core.seq(type_tokens)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21939,new cljs.core.Keyword("shitsuke","type","shitsuke/type",1602529816),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__21941){
var vec__21942 = p__21941;
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(0),null);
var ts = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21942,(1),null);
