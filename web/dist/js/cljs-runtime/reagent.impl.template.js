...
var G__22379 = o;
reagent.impl.template.goog$module$goog$object.set(G__22379,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22408 = o;
reagent.impl.template.goog$module$goog$object.set(G__22408,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__22418 = props;
var G__22418__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22418,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22418);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22418__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var G__22422 = (cljs.core.count(argv) - first_child);
switch (G__22422) {
case (0):
...
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22424,(2),null);
...
var temp__5829__auto___22532 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22532 == null)){
} else {
var key_22533 = temp__5829__auto___22532;
...
var temp__5829__auto___22534 = reagent.impl.util.react_key_from_vec(v);
if((temp__5829__auto___22534 == null)){
} else {
var key_22535 = temp__5829__auto___22534;
(jsprops.key = key_22535);
}
...
var temp__5829__auto___22536 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5829__auto___22536 == null)){
} else {
var key_22537 = temp__5829__auto___22536;
...
var temp__5829__auto___22538 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22538 == null)){
} else {
var key_22539 = temp__5829__auto___22538;
...
var temp__5829__auto___22540 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5829__auto___22540 == null)){
} else {
var key_22541 = temp__5829__auto___22540;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22445_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22445_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22451 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22451,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22451,(1),null);
...
break;
default:
var G__22543 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__22544 = compiler;
v = G__22543;
compiler = G__22544;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template22490 = (function (opts,id,fn_to_element,parse_fn,meta22491){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22490.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22492,meta22491__$1){
var self__ = this;
var _22492__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22490(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22491__$1));
}));

(reagent.impl.template.t_reagent$impl$template22490.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22492){
var self__ = this;
var _22492__$1 = this;
return self__.meta22491;
}));

(reagent.impl.template.t_reagent$impl$template22490.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22490.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22490.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22490.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22490.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22490.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22491","meta22491",1212535773,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22490.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22490.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22490");

(reagent.impl.template.t_reagent$impl$template22490.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22490");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22490.
 */
reagent.impl.template.__GT_t_reagent$impl$template22490 = (function reagent$impl$template$__GT_t_reagent$impl$template22490(opts,id,fn_to_element,parse_fn,meta22491){
return (new reagent.impl.template.t_reagent$impl$template22490(opts,id,fn_to_element,parse_fn,meta22491));
});
...
return (new reagent.impl.template.t_reagent$impl$template22490(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
