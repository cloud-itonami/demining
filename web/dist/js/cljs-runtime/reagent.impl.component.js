...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22198 = c;
var G__22198__$1 = (((G__22198 == null))?null:G__22198.prototype);
if((G__22198__$1 == null)){
return null;
} else {
return G__22198__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22201 = c;
var G__22201__$1 = (((G__22201 == null))?null:G__22201.prototype);
if((G__22201__$1 == null)){
return null;
} else {
return G__22201__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__22218 = c;
...
var _STAR_current_component_STAR__orig_val__22221 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22222 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22222);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22221);
}});
...
var c = this;
var G__22228_22423 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22228_22423 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22228_22423);
}
...
var renders_22440 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22441 = cljs.core.first(cljs.core.vals(renders_22440));
...
if((cljs.core.count(renders_22440) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22440))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22441)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22441], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22239 = o;
reagent.impl.component.goog$module$goog$object.set(G__22239,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22279 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22280 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22280);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22279);
}});
...
var vec__22282 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22282,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22282,(1),null);
...
var G__22287 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22287 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22287);
}
});
}),[]);
