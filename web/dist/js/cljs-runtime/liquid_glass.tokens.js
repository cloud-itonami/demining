...
(liquid_glass.tokens.spring_linear_easing.cljs$core$IFn$_invoke$arity$1 = (function (p__21996){
var map__21997 = p__21996;
var map__21997__$1 = cljs.core.__destructure_map(map__21997);
var zeta = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21997__$1,new cljs.core.Keyword(null,"zeta","zeta",257464678),0.55);
var omega = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21997__$1,new cljs.core.Keyword(null,"omega","omega",277265652),13.0);
var samples = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__21997__$1,new cljs.core.Keyword(null,"samples","samples",635504833),(16));
...
return ["linear(",clojure.string.join.cljs$core$IFn$_invoke$arity$2(",",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$iter__22004(s__22005){
return (new cljs.core.LazySeq(null,(function (){
var s__22005__$1 = s__22005;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22005__$1);
if(temp__5825__auto__){
var s__22005__$2 = temp__5825__auto__;
...
var i = cljs.core._nth(c__5478__auto__,i__22006);
cljs.core.chunk_append(b__22007,fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))));

var G__22127 = (i__22006 + (1));
i__22006 = G__22127;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22007),liquid_glass$tokens$iter__22004(cljs.core.chunk_rest(s__22005__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22007),null);
}
} else {
var i = cljs.core.first(s__22005__$2);
return cljs.core.cons(fmt(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(samples - (1))))?1.0:pos((i / (samples - (1)))))),liquid_glass$tokens$iter__22004(cljs.core.rest(s__22005__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$pair__GT_css_$_iter__22020(s__22021){
return (new cljs.core.LazySeq(null,(function (){
var s__22021__$1 = s__22021;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22021__$1);
if(temp__5825__auto__){
var s__22021__$2 = temp__5825__auto__;
if(cljs.core.chunked_seq_QMARK_(s__22021__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22021__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22023 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22022 = (0);
while(true){
if((i__22022 < size__5479__auto__)){
var vec__22028 = cljs.core._nth(c__5478__auto__,i__22022);
...
cljs.core.chunk_append(b__22023,["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''));

var G__22165 = (i__22022 + (1));
i__22022 = G__22165;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22023),liquid_glass$tokens$pair__GT_css_$_iter__22020(cljs.core.chunk_rest(s__22021__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22023),null);
}
} else {
var vec__22033 = cljs.core.first(s__22021__$2);
var pk = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22033,(0),null);
var pv = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22033,(1),null);
return cljs.core.cons(["  ",liquid_glass.tokens.css_var_name(group,k),"-",cljs.core.name(pk),": ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(pv),";"].join(''),liquid_glass$tokens$pair__GT_css_$_iter__22020(cljs.core.rest(s__22021__$2)));
}
} else {
return null;
}
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",(function (){var iter__5480__auto__ = (function liquid_glass$tokens$tokens__GT_body_$_iter__22037(s__22038){
return (new cljs.core.LazySeq(null,(function (){
var s__22038__$1 = s__22038;
while(true){
var temp__5825__auto__ = cljs.core.seq(s__22038__$1);
if(temp__5825__auto__){
var xs__6385__auto__ = temp__5825__auto__;
var vec__22045 = cljs.core.first(xs__6385__auto__);
var group = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22045,(0),null);
var m = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22045,(1),null);
var iterys__5476__auto__ = ((function (s__22038__$1,vec__22045,group,m,xs__6385__auto__,temp__5825__auto__){
return (function liquid_glass$tokens$tokens__GT_body_$_iter__22037_$_iter__22039(s__22040){
return (new cljs.core.LazySeq(null,((function (s__22038__$1,vec__22045,group,m,xs__6385__auto__,temp__5825__auto__){
return (function (){
var s__22040__$1 = s__22040;
while(true){
var temp__5825__auto____$1 = cljs.core.seq(s__22040__$1);
if(temp__5825__auto____$1){
var s__22040__$2 = temp__5825__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__22040__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__22040__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__22042 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__22041 = (0);
while(true){
if((i__22041 < size__5479__auto__)){
var vec__22054 = cljs.core._nth(c__5478__auto__,i__22041);
...
if((!((v == null)))){
cljs.core.chunk_append(b__22042,liquid_glass.tokens.pair__GT_css(group,k,v));

var G__22183 = (i__22041 + (1));
i__22041 = G__22183;
continue;
} else {
var G__22184 = (i__22041 + (1));
i__22041 = G__22184;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__22042),liquid_glass$tokens$tokens__GT_body_$_iter__22037_$_iter__22039(cljs.core.chunk_rest(s__22040__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__22042),null);
}
} else {
var vec__22058 = cljs.core.first(s__22040__$2);
...
if((!((v == null)))){
return cljs.core.cons(liquid_glass.tokens.pair__GT_css(group,k,v),liquid_glass$tokens$tokens__GT_body_$_iter__22037_$_iter__22039(cljs.core.rest(s__22040__$2)));
} else {
var G__22188 = cljs.core.rest(s__22040__$2);
s__22040__$1 = G__22188;
continue;
}
}
} else {
...
});})(s__22038__$1,vec__22045,group,m,xs__6385__auto__,temp__5825__auto__))
,null,null));
});})(s__22038__$1,vec__22045,group,m,xs__6385__auto__,temp__5825__auto__))
;
var fs__5477__auto__ = cljs.core.seq(iterys__5476__auto__(m));
if(fs__5477__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__5477__auto__,liquid_glass$tokens$tokens__GT_body_$_iter__22037(cljs.core.rest(s__22038__$1)));
} else {
var G__22189 = cljs.core.rest(s__22038__$1);
s__22038__$1 = G__22189;
continue;
}
} else {
return null;
